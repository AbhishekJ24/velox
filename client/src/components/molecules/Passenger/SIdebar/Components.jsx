...
const Sidebar = ({ active }) => {
  ...
  return (
    <div className="relative max-h-svh  ">
      ...
      <div
        className={`bg-white w-[240px] pl-2 pr-2 flex flex-col fixed lg:static shadow-xl  border lg:translate-x-0 transition-transform duration-300 transform ${isSidebarOpen ? 'translate-x-0 shadow-2xl' : '-translate-x-full'
      ...
      >
        ...
        <div>
          <h1 className="p-3 flex justify-center text-colorBlue font-bold text-[30px] rounded-2xl">Velox</h1>
