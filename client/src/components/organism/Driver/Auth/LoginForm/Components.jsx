...
import VeloxImage from '../../../../../assets/velox.png';
        ...
        <div className='flex justify-center mt-5 pt-10 '>
            <Card className="flex flex-col md:flex-row w-full max-w-[95%] md:max-w-[900px] h-[auto] md:h-[600px] pt-[50px] rounded overflow-hidden animate-fadeIn">
                <div className='p-3 w-full md:w-[70%] md:ml-5'>
                    ...
                    <div>
                        <h1 className='pt-5 pb-5'>Welcome to Velox! Please login to your account!</h1>
                    </div>
                ...
                <div className='w-full'>
                    <div className='w-full flex items-center justify-center'>
                        <img src={VeloxImage} alt="Velox Logo" className="w-full max-w-[200px] md:max-w-[400px] h-auto object-contain" />
                    </div>
                </div>
            </Card>
        </div>
